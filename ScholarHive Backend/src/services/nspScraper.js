...
scholarships.forEach(async (scholarship)=>{
    try{
        ...
        scholarship.academicCriteria = nspDetails.academicCriteria; 
        scholarship.incomeCriteria = nspDetails.incomeCriteria; 
        scholarship.categoryCriteria = nspDetails.categoryCriteria; 
        scholarship.ageLimit = nspDetails.ageLimit;
